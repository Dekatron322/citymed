        ...
        <div className="flex flex-col gap-2 max-md:hidden ">
          {filteredList.map((appointment) => (
            ...
            >
              ...
              <div>
                <p className="rounded bg-[#50c9f4] px-2 py-[2px] text-xs text-[#000000]">{appointment.status}</p>
              </div>
        ...
        <div className="flex flex-col gap-2 max-md:hidden ">
          {billingRecord.map((appointment) => (
            ...
            >
              ...
              <div>
                <p className="rounded bg-[#50c9f4] px-2 py-[2px] text-xs text-[#000000]">{appointment.complain}</p>
                <small className="text-xm ">complain</small>
              </div>
